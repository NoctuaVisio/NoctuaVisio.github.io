...
(function (global) {
  ...
  const DICT = {
    pt: {
      ...
      'admin.modal.link.thumb':         'Thumbnail (preview do compartilhamento)',
      'admin.modal.link.thumb_iso':     'Isométrica',
      'admin.modal.link.thumb_current': 'Visão atual',
      'admin.modal.link.thumb_none':    'Não gerar',
      'admin.modal.link.access':            'Acesso do cliente',
      'admin.modal.link.access_protected':  'Protegido',
      'admin.modal.link.access_open':       'Livre',
      'admin.modal.link.access_hint':       'Protegido = precisa logar pra ver. Livre = abre direto pra qualquer um, sem registro.',
